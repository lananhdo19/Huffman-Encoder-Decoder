//Lan Anh Do ld9hu heap.cpp 11/27/18
...
binary_heap::binary_heap(vector<Node *> vec) : heap_size(vec.size()) {
    heap = vec;
...
void binary_heap::insert(Node* x) {
